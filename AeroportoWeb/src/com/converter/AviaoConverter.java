...
@FacesConverter(forClass = com.model.Aviao.class)
public class AviaoConverter implements Converter {

	@Override
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
		AviaoBO aviaoBO = new AviaoBO();
		Long aviaoId;

		try {
			aviaoId = Long.parseLong(arg2);
		...
		return aviaoBO.pesquisar(aviaoId);
	}
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
		...
		Aviao aviao = (Aviao) arg2;
		return String.valueOf(aviao.getId());
	}
}
